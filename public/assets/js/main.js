...
(function ($) {
	...
	////////////////////////////////////////////////////
	// 03. Common Js
	function tp_set_backgrounds() {
		var isMobile = window.matchMedia("(max-width: 767px)").matches;

		$("[data-background]").each(function () {
			var $el = $(this);
			var desktopSrc = $el.attr("data-background");
			var mobileSrc = $el.attr("data-background-mobile");
	...
	tp_set_backgrounds();
	windowOn.on("resize orientationchange", tp_set_backgrounds);
	...
	if ($('.tp-team-item').length > 0 && $('.tp-project-textline').length > 0) {
	...
	if ($('.dddd').length > 0) {
		...
		if ($('.dddd .tp-project-5-2-img-1').length > 0) {
		...
		if ($('.dddd .tp-project-5-2-img-2').length > 0) {
	...
	if ($('.tp-main-menu-content').length && $('.tp-main-menu-mobile').length) {
		...
		// Remove text-white class from mobile menu
		$('.tp-main-menu-mobile .text-white').removeClass('text-white');
		...
		arrow.each(function () {
			...
			arrowBtn.innerHTML = window.LucideSvg ? window.LucideSvg.plus(18) : "+";
